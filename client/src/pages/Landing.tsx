...
export default function Landing() {
  ...
  <nav class="nav">
    ...
    <ul class="nav-links">
      ...
      <li><a href="/app/self-order">Menu</a></li>
      <li><a href="#experience">Craft</a></li>
      <li><a href="#contact">Find Us</a></li>
      <li><a href="/app/self-order" class="nav-cta">Order Now</a></li>
  ...
  <section class="hero" id="home">
    <div class="hero-left">
      ...
      <div class="hero-cta-row reveal reveal-delay-3">
        <a href="/app/self-order" class="btn-primary" id="explore-menu-btn"><span>View Menu</span></a>
  ...
  <section class="impact-menu" id="menu">
    ...
    <div class="iced-series-container">
      ...
      <div class="iced-series-cta reveal">
        <a href="/app/self-order" class="iced-order-btn">ORDER NOW</a>
      </div>
  ...
  <footer class="footer" id="contact">
    ...
    <div class="footer-col">
      <h4>Menu</h4>
      <ul>
        <li><a href="/app/self-order">Espresso Bar</a></li>
        <li><a href="/app/self-order">Cold Brew</a></li>
        <li><a href="/app/self-order">Pour Over</a></li>
        <li><a href="/app/self-order">Seasonal Specials</a></li>
      </ul>
    </div>
    <div class="footer-col">
      <h4>Company</h4>
